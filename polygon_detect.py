...
def detect(weights='polygon-yolov5s-ucas.pt',  # model.pt path(s)
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            # Print time (inference + polygon NMS)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='polygon_best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='data/images/armor', help='file/dir/URL/glob, 0 for webcam')
